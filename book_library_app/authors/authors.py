...
from book_library_app.utils import validate_json_content_type, get_schema_args, \
...
def get_author(author_id: int):
    author = db.get_or_404(Author, author_id, description=f'Author with id {author_id} not found')
    return jsonify({
        'success': True,
